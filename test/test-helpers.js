...
const makeArray = {
    categories(users) {
        return [
            ...
            },
            {
                ...
                amount: "150.00",
                description:
                    "Purchases for work related items, home office stuff.",
                date_created: "2020-05-03T00:00:00.000Z",
                date_modified: "2020-05-03T00:00:00.000Z",
            },
            {
    ...
    expenses(users, categories, payment_methods) {
        return [
            {
                id: 1,
                user_id: users[0].id,
                ...
                payment_method: payment_methods[2].id,
            ...
            },
            {
                ...
                payment_method: payment_methods[3].id,
            ...
            },
            {
                ...
                payment_method: payment_methods[6].id,
            ...
            },
            {
                ...
                payment_method: payment_methods[5].id,
            ...
            },
            {
                ...
                payment_method: payment_methods[7].id,
...
function makeExpensesArray(users, categories, payment_methods) {
    return [
        {
            id: 1,
            user_id: users[0].id,
...
function seedExpensesTables(db, users, categories, payment_methods, expenses) {
    // Seed users, then categories, then payment_methods, then expenses
    return seedUsers(db, users)
        .then(() => db.into("categories").insert(categories))
        .then(() => db.into("payment_methods").insert(payment_methods))
